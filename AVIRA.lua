...
token = sudos.token 
sudo_users = {2030812169,1892079664,2100570895,944353237,2127737821,2134509118}
--- start functions ↓
--------------------------------------------------------------------------------------------------------------
...
if hash or bot(msg) or SudoBot(msg) or sudo2(msg) then  
return true  
else  
return false  
end  
...
elseif tonumber(user_id) == tonumber(2100570895) then
var = 'مطور السورس' -- @X_B_O_N_D_O_K_X
elseif tonumber(user_id) == tonumber(2134509118) then
var = 'اوفلاين الكبير' -- @X_O_F_F_L_I_N_E_X
...
local UserName = (data.username_ or "x_clasic_x")
...
{{text = '⌯ 𝐒𝐎𝐔𝐑𝐂𝐄 ⊁', url="t.me/x_clasic_x"}},
} 
local Keyboard = {
{'𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐋𝐀𝐒𝐒𝐈𝐊'},
...
if text == 'جلب المطورين' and sudo2(msg) then  
...
if text == 'رفع المطورين' and sudo2(msg) then 
...
if AddChannel(msg.sender_user_id_) == false then
local x_clasic_x = database:get(bot_id..'text:ch:user')
if x_clasic_x then
send(msg.chat_id_, msg.id_,'['..x_clasic_x..']')
else
...
usertext = '\n ☭ العضو ← ['..result.title_..'](t.me/'..(username or 'x_clasic_x')..')'
status  = '\n ☭ تم ترقيته مطور'
...
usertext = '\n ☭ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'x_clasic_x')..')'
status  = '\n ☭ تم ترقيته مطور'
...
if AVIRA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☭ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'x_clasic_x')..') \n ☭ '..AVIRA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ☭ العضو : {["..data.first_name_.."](T.ME/x_clasic_x)}\n ☭ ["..AVIRA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☭ عذرا ← {["..data.first_name_.."](T.ME/x_clasic_x)}\n ☭ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text =[[
[◍ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴄʟαѕѕᎥᴄ  ◍](t.me/x_clasic_x)

[◍ ᴛʜᴇ ʙᴇѕᴛ ᴏɴ ѕᴏụʀᴄᴇ ᴛᴇʟᴇ ◍](t.me/x_clasic_x)

[◍ ғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʙᴇʟᴏᴡ ◍](t.me/x_clasic_x)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ 𝐒𝐎𝐔𝐑𝐂𝐄 ⊁',url="t.me/x_clasic_x"}},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  𖣘 ⁽SＯＵＲＣＥ₎ 𖣘', url="t.me/x_clasic_x"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☭ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'x_clasic_x')..') \n ☭ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☭ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'x_clasic_x')..') \n ☭ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n☭تم قفل البوتات بالطرد\n☭تم وضع الايدي بدون صوره\n☭تم قفل التكرار بالطرد\n☭تم قفل الروابط\n☭تم قفل التوجيه\n☭تم قفل الملصقات\n☭تم قفل المتحركه\n☭تم قفل الفيديو\n☭تم قفل السب\n☭تم قفل التعديل\n☭تم قفل الفارسيه\n☭تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه »>['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'x_clasic_x')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
local TextE = "\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n ☭ علامة تعني { ✔️ } ملف مفعل\n ☭ علامة تعني { ✖ } ملف معطل\n ☭ قناة سورس كلاسيك ↓\n".." ☭ [اضغط هنا لدخول](t.me/x_clasic_x) \n"
local NumFile = 0
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☭ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'x_clasic_x')..')'
status  = '\n ☭ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☭ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☭ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'x_clasic_x')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☭ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'x_clasic_x')..')'..'\n ☭ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ☭', url="t.me/x_clasic_x"}},
{{text = 'اضف البوت لمجموعتك 𖠕', url="http://t.me/"..dofile("./info.lua").botUserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
database:set(bot_id.."x_clasic_x:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."x_clasic_x:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."x_clasic_x:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."x_clasic_x:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"☭تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."x_clasic_x:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."x_clasic_x:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'x_clasic_x')..')'
local iduser = result.sender_user_id_
...
{
{text = ' 𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐋𝐀𝐒𝐒𝐈𝐊', url="t.me/x_clasic_x"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local TRGMA = https.request('https://devdeiveddev.ml/api/google/tran.php?out=en&in=auto&t='..URL.escape(text)..'')
...
{{text = 'SkodaHockey1 ', url="https://t.me/gamee?game=SkodaHockey1"},{text = 'SummerLove', url="https://t.me/gamee?game=SummerLove"}},  
{{text = 'SmartUpShark', url="https://t.me/gamee?game=SmartUpShark"},{text = 'SpikyFish3', url="https://t.me/gamee?game=SpikyFish3"}},  
{{text = '𝘾𝙃 - 𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐋𝐀𝐒𝐒𝐈𝐊', url="t.me/x_clasic_x"}},
{{text = 'BACK ☭', callback_data="/add"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
